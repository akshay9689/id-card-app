                                ...
                                <div class="card card-stretch">
                                    <div class="card-inner-group">
                                        <div class="card-inner position-relative card-tools-toggle">
                                            ...
                                            <form method="post" action="{{ route('reset-password') }}" class="form-validate" >@csrf
                                                <div class="row g-gs">

                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="fv-full-name">Old Password</label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="fv-full-name">New Password</label>
                                                    <div class="form-control-wrap">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="fv-full-name">Re Enter Password</label>
                                                    <div class="form-control-wrap">
