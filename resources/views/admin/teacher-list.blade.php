                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des text-soft">
                                            <p>You have total {{ $data->total() }} Teacher's.</p>
                                        </div>
...
@endif
                                            <form method="post" action="{{ route('teacher') }}" class="form-validate" enctype="multipart/form-data">@csrf
                                                <div class="row g-gs">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" value="{{old('username')}}" name="name" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            ...
                                                                            <li>
                                                                                ...
                                                                                <em class="icon ni ni-pen"></em><span>Edit Teacher</span></a> 
                                                                            </li>

                                                                           <?php if($user->status === 0) {?>
                                                                            <li><a type="button" data-bs-toggle="modal" data-bs-target="#modalstatus<?php echo $user->id;?>"><em class="icon ni ni-cross-fill-c"></em><span>Deactive</span></a></li>
                                                                            <?php } else { ?>
                                                                            <li><a type="button" data-bs-toggle="modal" data-bs-target="#modalstatus<?php echo $user->id;?>"><em class="icon ni ni-check-c"></em><span>Active</span></a></li>
                                                                            <?php } ?>
                                                                           
                                                                            <li class="divider"></li>
                                                                            
                                                                            <li>
                                                                                 <a type="button" data-bs-toggle="modal" data-bs-target="#modaldelete<?php echo $user->id;?>">
                                                                                    <em class="icon ni ni-trash-alt"></em><span>Delete Teacher</span></a> 
                                                                                </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('update-teacher', $user->id) }}" class="form-validate is-alter">
...
<div class="modal fade" tabindex="-1" id="modalstatus<?php echo $user->id;?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
...
<div class="modal fade" tabindex="-1" id="modaldelete<?php echo $user->id;?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
