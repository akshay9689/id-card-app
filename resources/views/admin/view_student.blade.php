                            ...
                            <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h3 class="nk-block-title page-title">View Student</h3>
                                            ...
                                            <input type="hidden" name="student_id" value="{{ $data->id}}">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" name="admission_no" value="{{ $data->admission_no}}" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" value="{{ $data->roll_no }}" name="roll_no" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" value="{{ $data->first_name }}" name="first_name" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" value="{{ $data->middle_name }}" name="middle_name" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" value="{{ $data->last_name }}" name="last_name" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="date" class="form-control" value="{{ $data->dob }}" name="dob" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <select name="blood_group" class="form-control" readonly>
                                                                    <option value="">--select--</option>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" value="{{ $data->father_name }}" name="father_name" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" value="{{ $data->father_mobile }}" name="father_mobile" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" value="{{ $data->mother_name }}" name="mother_name" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" value="{{ $data->mother_mobile }}" name="mother_mobile" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" value="{{ $data->student_house }}" name="student_house" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <textarea class="form-control" name="address"  readonly>{{ $data->address }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
