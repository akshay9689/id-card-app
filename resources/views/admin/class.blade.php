                            ...
                            <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h3 class="nk-block-title page-title">Create Class</h3>
                                        <div class="nk-block-des text-soft">
                                            <p>You have total {{ $data->total() }} Class's.</p>
                                        </div>
...
@endif
                                            <form method="post" action="{{ route('classes') }}" class="form-validate" enctype="multipart/form-data">@csrf
                                                <div class="row g-gs">
                                                                ...
                                                                <div class="g-3">
                                                                    ...
                                                                    <div class="g">
                                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" name="divisions[]" value="{{ $division->id }}" id="div{{ $division->id}}">
                                                 ...
                                                 <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info">
                                                                <span class="tb-lead"> {{ $class->name}} <span class="dot dot-success d-md-none ms-1"></span></span>
                                                            </div>
                                              
                                                @php

                                                $arr = App\Models\ClassDivision::where(['class_id' => $class->id])->orderBy('id', 'ASC')->get()->toArray();
                                                if(count($arr) > 0){

                                                 $array = $arr;

                                                // $division_id = $arr[0]['division_id'];
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            for($i=0; $i <= count($array) - 1; $i++){
                                                               ...
                                                               $division_id = $array[$i]['division_id'];
                   
                                                               $arr = App\Models\Division::where(['id' => $division_id])->orderBy('id', 'DESC')->get()->toArray();
                                                               if(count($arr) > 0){
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            ...
                                                                            <li>
                                                                                <a type="button" href="{{ route('edit-class', $class->id ) }}">
